...
public class StudioBrowseSandboxImpexAction extends AnAction implements DumbAware {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        if (hostname != null && !hostname.isEmpty()) {
            BrowserUtil.browse("https://" + hostname + "/on/demandware.servlet/webdav/Sites/Impex/");
        } else {
